...
interface in Annamarie's task manager UI at localhost:3456.
...
- "spec" / "agent spec" = design doc in 01-Creating/Oasis — Agent Specs/. YAML frontmatter with status: drafting|ready|building|shipped.
...
Target repos for /handoff:
- Backend (Django): /Users/annamarie/dev/digital-garden
- iOS (SwiftUI): /Users/annamarie/dev/ios-oasis
- Web (Next.js): /Users/annamarie/dev/web-oasis
- Loops UI: /Users/annamarie/loops-os/loops-ui

Vault folders: 00-Inbox, 01-Creating, 02-Thinking, 03-Living, 04-Relating, 05-Archive, 06-Loops.
