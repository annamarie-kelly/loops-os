...
// Customize these to match your vault layout:
const SPECS_FOLDER = process.env.LOOPS_SPECS_FOLDER || '01-Building/Agent Specs';
// Codebase docs folders — HTML files here show as "shipped" artifacts.
// Set LOOPS_CODEBASE_DOCS as JSON array, e.g.:
// [{"dir":"/path/to/repo/docs","repo":"backend"}]
const CODEBASE_DOCS: { dir: string; repo: string }[] = process.env.LOOPS_CODEBASE_DOCS
